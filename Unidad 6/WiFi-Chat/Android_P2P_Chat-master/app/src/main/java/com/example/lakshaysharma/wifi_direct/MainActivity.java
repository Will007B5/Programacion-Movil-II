...
public class MainActivity extends AppCompatActivity {
    ...
    public Button getBtnOnOff() {
        return btnOnOff;
    }

    public void setBtnOnOff(Button btnOnOff) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wifiActivado = new WifiBroadcastReceiver(wifiP2pManager, channel, this).isWifiActive();
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                wifiP2pManager.connect(channel, config, new WifiP2pManager.ActionListener() {
                    ...
                    public void onSuccess() {
                        Toast.makeText(MainActivity.this, "Conectado a " + device.deviceName, Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onFailure(int reason) {
                        Toast.makeText(MainActivity.this, "La conexion falló con " + device.deviceName, Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
    ...
    private void UIInit() {
        ...
        if(wifiActivado == true){
            btnOnOff.setText(R.string.wifiOff);
        }

        if(wifiActivado == false){
    ...
    public void discoverPeers(View view) {
        wifiP2pManager.discoverPeers(channel, new WifiP2pManager.ActionListener() {
            @Override
            public void onSuccess() {
                connectionStatus.setText("Buscando...");
            }
    ...
    WifiP2pManager.PeerListListener peerListListener = new WifiP2pManager.PeerListListener() {
        ...
        public void onPeersAvailable(WifiP2pDeviceList peersList) {
            ...
            if(peers.size() == 0){
                Toast.makeText(getApplicationContext(), "Dispositivos no encontrados", Toast.LENGTH_LONG).show();
            }
        }
    };
    ...
    public void sendMessage(View view) {
        ...
        if (isServer){
            sendRecieve.write(("SERVIDOR: " + message).getBytes());
            updateMessageList("SERVIDOR: " + message);
        }
        else if (isClient){
            sendRecieve.write(("CLIENTE: " + message).getBytes());
            updateMessageList("CLIENTE " + message);
        }
